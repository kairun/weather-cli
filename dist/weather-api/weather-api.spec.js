...
describe('WeatherApi', () => {
    ...
    describe('getWeatherToday', () => {
        ...
        it('should throw UnexpectedInputError if unexpected input is given', async () => {
            await expect(weatherApi.getWeatherToday('unexpected')).rejects.toThrow(errors_1.UnexpectedInputError);
        });
    });
    afterAll(() => {
        jest.unmock('axios');
...
//# sourceMappingURL=weather-api.spec.js.map